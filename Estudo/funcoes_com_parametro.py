"""
Funções com Parâmetro (da entrada)
...
print(soma(2, 3, 4)) # TypeError -  Passando argumento a mais
print(soma(4)) # TypeError -  Passando argumento a menos
...
# Caso utilizemos nomes dos parâmetros nos argumentos para informá-lo, podemos utilizar qualquer ordem.
...
if __name__ == '__main__':
    ...
    print('O Modulo funcoes_com_parametro.py foi importado')
