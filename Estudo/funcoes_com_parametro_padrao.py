...
deste número;
Se o usuário passar 2 argumentos, o primeiro será atribuído ao parâmetro numero e o segundo parâmetro potencia. Então
...
Quais tipos de dados podem utilizar como valores default para parâmetros?

- Qualquer tipo de dado:
    - Número, strings, floats, booleanos, listas, tuplas, dicionário, funções e etc;
