...
print(dict1 == dict2) - True -> Já que a ordem dos elementos não importam para o dicionário
...
print(dict1 == dict2) - False -> já que a ordem dos elementos importa para o OrderedDict
"""
