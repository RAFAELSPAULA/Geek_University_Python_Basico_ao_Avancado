...
# Qual é a utilidade de getsizeof()? -> Retorna a quantidade de bytes em mémoria do elemento passado como parâmetro
...
print('Parra fazer a mesma tarefa gastamos em memória: ')
print(f'List Comprehension: {list_comp} bytes')
print(f'Set Comprehension: {set_comp} bytes')
print(f'Disc Comprehension: {dic_comp} bytes')
