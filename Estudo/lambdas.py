...
#OBS: Se passarmos mais argumentos do que parâmentros esperados teremos TypeError

# Outro Exemplo

autores = ['Issac Asimov', 'Ray Bradbury', 'Arthur C. Clarke', 'Frank Herbert', 'Orson Scott Card', 'Douglas Adams', 'H.G. Wells', 'Leigh Brackett']
