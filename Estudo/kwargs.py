...
utilizemos parâmetros nomeados, e transforma esses parâmetros extra em um dicionário.
...
# OBS! Os números da chave em um dicionário devem ser  o mesmo  dos parâmetros da função

# dicionario = dict(d=1, e=1, f=1) # TypeError
# soma_multiplos_numeros(**dicionario)
